...
namespace Web.Infrastructure.Stream
{
    /// <summary>
    ...
    /// </remarks>
    /// </summary>    
    public class ResponseFilterStream : System.IO.Stream
    {
        /// <summary>
        /// The original stream
        /// </summary>
        ...
        /// <summary>
        /// Creates a new plugin filter stream
        /// </summary>
        /// <param name="responseStream"></param>
        /// <param name="httpContext"></param>
        public ResponseFilterStream(System.IO.Stream responseStream, HttpContext httpContext)
        {
        ...
        private void OnCaptureStringInternal(MemoryStream ms)
        {
            ...
            {
                string content = _httpContext.Response.ContentEncoding.GetString(ms.ToArray());
        ...
        {
            Encoding encoding = _httpContext.Response.ContentEncoding;
        ...
        internal MemoryStream OnTransformCompleteStringInternal(MemoryStream ms)
        {
            ...
            byte[] buffer = _httpContext.Response.ContentEncoding.GetBytes(content);
            ms = new MemoryStream();
