...
{
    public class WidgetDownloadManager : UpdateDownloadManager
    {
        ...
        private static readonly WidgetDownloadManager Instance = new WidgetDownloadManager();

        private readonly ConcurrentDictionary<int, ThirdPartyDownloadUpdate> _thirdPartydownloadUpdates;

        public static WidgetDownloadManager Manager
        {
            get
            {
                return Instance;
